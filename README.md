...
- 🖼️ **Gallery:** View a collection of our signature cakes with images and descriptions.
- 🛠️ **Admin Panel:** Secure backend for managing cakes, orders, and customers.
...
1. **Clone the Repository**
   ```bash
   git clone https://github.com/JuanSoFly/cake-website.git
   cd cake-website
   ```
...
| :-------------------------------- | :------------------------------ | :------------------------------ |
| ![](screenshots/homepage.png)     | ![](screenshots/gallery.png)    | ![](screenshots/adminpanel.png) |
